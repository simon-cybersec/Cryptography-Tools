...
# By including this signature_string in an image the app knows theres a message in it
signature_string = "5t3g0051gn4tur35tr1ng"
...
def encode(image, data_string, output_filename):
    ...
    # Add the signature before and after the data
    ...
    print(f'[+] Used bytes: {len(data_bits)}')
    ...
    if output_filename is not None:
        print("[+] Saving image " + output_filename + ".png ...")
